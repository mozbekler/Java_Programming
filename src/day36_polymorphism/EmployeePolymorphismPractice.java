...
public class EmployeePolymorphismPractice {
    public static void main(String[] args) {
        ...
        for (Tester each : testers) {
            if (each.getSalary()==maxSalaryTester){
                System.out.println(each.getName()+" has the highest salary among testers($"+each.getSalary()+")");
            }
        }
        ...
        for (Developer each : developers) {
            if (each.getSalary()==maxSalaryDeveloper){
                System.out.println(each.getName()+" has the highest salary among developers($"+each.getSalary()+")");
            }
        }
