    ...
    public static void main(String[] args) {
        ...
        for (Car each : cars) {
            if ((each instanceof Honda) && (each.getYear()>=2010 && each.getYear()<=2011)){
                System.out.println(each.getMake()+" - "+each.getModel()+" is eligible for recall");
        ...
        for (Car each : cars) {
            if (each.getPrice()==highestPrice){
                System.out.println(each.getMake()+" - "+each.getModel()+" : ($"+each.getPrice()+") is the car with the highest price. ");
            }
        }
        System.out.println("---------------------------------------------------");
        ...
        for (Car each : cars) {
            if (each.getPrice()==lowestPrice){
                System.out.println(each.getMake()+" - "+each.getModel()+" : ($"+each.getPrice()+") is the car with the lowest price. ");
            }
        }
