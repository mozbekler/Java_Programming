...
public class ArrayListPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of female employees: "+ femaleEmployees.size());

        System.out.println("Number of male employees: "+ maleEmployees.size());

        for (Employee femaleEmployee : femaleEmployees) {
            System.out.println("female employees: "+femaleEmployee.name);
        }

        for (Employee maleEmployee : maleEmployees) {
            System.out.println("male employees: "+maleEmployee.name);
        }
